...
module.exports = {
     ...
     */
    createDevice(token, profileId, locationId, installedAppId, label, externalId) {
        log.debug(`create(profileId:${profileId}, locationId:${locationId}, installedAppId:${installedAppId})`);
        let body = {
            label: label,
    ...
    sendEvents(token, deviceId, events) {
        ...
        let options = {
            ...
            body: JSON.stringify({ deviceEvents: events })
        };
